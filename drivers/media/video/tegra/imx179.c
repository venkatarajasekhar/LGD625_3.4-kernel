...
static int imx179_open(struct inode *inode, struct file *file)
{
	...
	err = imx179_pm_api_wr(info, NVC_PWR_ON);
	dev_dbg(&info->i2c_client->dev, "%s -----\n", __func__);
	return 0;
}
	...
	const struct i2c_device_id *id)
{
	...
	pr_err("[imx179]: probing sensor done.\n");
