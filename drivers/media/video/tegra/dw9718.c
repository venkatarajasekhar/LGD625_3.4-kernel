...
#define dw9718_SLEW_RATE		0x080006
#define dw9718_ACTUATOR_RANGE		1023
#define dw9718_SETTLETIME		12
#define dw9718_FOCUS_MACRO		580
#define dw9718_FOCUS_INFINITY		230
...
static int dw9718_power_get(struct dw9718_info *info)
{
	...
	dw9718_regulator_get(info, &pw->vdd, "vdd_cam_1v8");
...
static void dw9718_get_focuser_capabilities(struct dw9718_info *info)
{
	...
	pr_info("%s: working_low = %d, working_high = %d\n", __func__,
		...
		const struct i2c_device_id *id)
{
	...
	pr_info("dw9718: probing focuser done.\n");
	return 0;
}
