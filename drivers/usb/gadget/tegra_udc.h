...
/*                                                                                              */
#define USB_CHARGING_NON_STANDARD_CHARGER_CURRENT_LIMIT_UA 1800000u
/*                                                                                            */
#ifdef CONFIG_MACH_PDA
#define USB_CHARGING_LGE_FACTORY_UA 1800000u /* for factory cable juya.kim */
#define USB_CHARGING_LGE_INBOX_TA_CURRENT_LIMIT_UA 850000u /* for LG Inbox TA juya.kim */
#endif

 /* 1 sec wait time for non-std charger detection after vbus is detected */
#define NON_STD_CHARGER_DET_TIME_MS 2000
#define FACTORY_CHARGER_DET_TIME_MS 16000
...
enum tegra_connect_type {
	...
	CONNECT_TYPE_LGE_FACTORY /* juya.kim */
};
