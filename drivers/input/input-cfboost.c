...
static bool cfb_input_match(struct input_handler *handler,
			    struct input_dev *dev)
{
#ifdef CONFIG_MACH_PDA
	/* Don't attach bma2x2 as an input boost device. */
	if (!strncmp(dev->name, "bma2x2", strlen("bma2x2")))
		return false;
#endif
	return true;
}
