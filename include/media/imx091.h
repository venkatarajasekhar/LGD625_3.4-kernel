...
#define IMX091_EEPROM_ADDRESS	0x53
#define IMX091_EEPROM_SIZE	4096
#define IMX091_EEPROM_BLOCK_SIZE	(1 << 8)
#define IMX091_EEPROM_NUM_BLOCKS \
	(IMX091_EEPROM_SIZE / IMX091_EEPROM_BLOCK_SIZE)
