...
struct clk tegra_list_clks[] = {
	...
	SHARED_SCLK("uarta.sclk", "tegra_uart.0",	"sclk",	&tegra_clk_ahb,        NULL, 0, 0),
	SHARED_SCLK("uartb.sclk", "tegra_uart.1",	"sclk",	&tegra_clk_ahb,        NULL, 0, 0),
	SHARED_SCLK("uartc.sclk", "tegra_uart.2",	"sclk",	&tegra_clk_ahb,        NULL, 0, 0),
	SHARED_SCLK("uartd.sclk", "tegra_uart.3",	"sclk",	&tegra_clk_ahb,        NULL, 0, 0),
	...
	SHARED_SCLK("i2s0.sclk", "tegra30-i2s.0",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	SHARED_SCLK("i2s1.sclk", "tegra30-i2s.1",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	SHARED_SCLK("i2s2.sclk", "tegra30-i2s.2",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	SHARED_SCLK("i2s3.sclk", "tegra30-i2s.3",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	SHARED_SCLK("i2s4.sclk", "tegra30-i2s.4",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	...
	SHARED_EMC_CLK("uarta.emc",	"tegra_uart.0",		"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("uartb.emc",	"tegra_uart.1",		"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("uartc.emc",	"tegra_uart.2",		"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("uartd.emc",	"tegra_uart.3",		"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("i2s0.emc",	"tegra30-i2s.0",	"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("i2s1.emc",	"tegra30-i2s.1",	"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("i2s2.emc",	"tegra30-i2s.2",	"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("i2s3.emc",	"tegra30-i2s.3",	"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
	SHARED_EMC_CLK("i2s4.emc",	"tegra30-i2s.4",	"emc",	&tegra_clk_emc, NULL, 0, 0, 0),
