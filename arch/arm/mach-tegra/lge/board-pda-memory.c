...
#else
/*                                */
static struct tegra14_emc_table pda_ddr2_elpida_edb8132b3ph_table[] = {
	{
		0x52,       /* Rev 5.3.8.d */
		...
		9,          /* number of up_down_regs */
		{
			...
			0x001a0007, /* EMC_MRS_WAIT_CNT */
			0x001a0007, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG3 */
			0xa0f10000, /* EMC_AUTO_CAL_CONFIG */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
			0x80000124, /* EMC_DYN_SELF_REF_CONTROL */
			0x00000003, /* EMC_QUSE */
			...
			0x80000031, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			0x80000024, /* MC_EMEM_ARB_OUTSTANDING_REQ_RING3 */
			0x00000001, /* MC_EMEM_ARB_TIMING_RCD */
			0x00000001, /* MC_EMEM_ARB_TIMING_RP */
			0x00000002, /* MC_EMEM_ARB_TIMING_RC */
			0x00000000, /* MC_EMEM_ARB_TIMING_RAS */
		...
		0x0000000a, /* EMC_ZCAL_WAIT_CNT for ZQcal Long */
		0x001fffff, /* EMC_AUTO_CAL_INTERVAL */
		0xf320008e, /* EMC_CFG */
		0x00580048, /* EMC_CFG_DIG_DLL */
		0x00000000, /* Mode Register 0 */
...
static struct tegra14_emc_table pda_ddr2_elpida_edb8132b3ph_table_der[] = {
	{
		0x52,       /* Rev 5.3.8.d */
...
static struct tegra14_emc_table pda_ddr2_elpida_edb8132b3ph_table_ll[] = {
	{
		0x52,       /* Rev 5.3.8.d */
...
static struct tegra14_emc_table pda_ddr2_elpida_edb8132b3ph_table_ll_der[] = {
	{
		0x52,       /* Rev 5.3.8.d */
...
static struct tegra14_emc_pdata pda_ddr2_emc_pdata = {
	.description = "pda_ddr2_elpida_edb8132b3ph_tables",
	.tables = pda_ddr2_elpida_edb8132b3ph_table,
	.tables_derated = pda_ddr2_elpida_edb8132b3ph_table_der,
	.tables_low_latency = pda_ddr2_elpida_edb8132b3ph_table_ll,
	.tables_low_latency_derated = pda_ddr2_elpida_edb8132b3ph_table_ll_der,
	.num_tables = ARRAY_SIZE(pda_ddr2_elpida_edb8132b3ph_table),
};
...
int __init pda_emc_init(void)
{
	...
	case BOARD_E1690:
		...
		if (tegra_sku_id == 0x3) {
			pr_info("Loading PD_A SL460 EMC tables.\n");
			tegra_emc_device.dev.platform_data = &atlantis_emc_pdata;
		} else {
			pr_info("Loading PD_A SL440 EMC tables.\n");
			tegra_emc_device.dev.platform_data = &pda_ddr2_emc_pdata;
		}
		break;
#else
