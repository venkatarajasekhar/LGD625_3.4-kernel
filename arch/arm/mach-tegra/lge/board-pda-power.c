/*
 * arch/arm/mach-tegra/lge/board-pda-power.c
 *
...
static struct regulator_consumer_supply max77660_ldo2_supply[] = {
	...
	REGULATOR_SUPPLY("vana_imx091", "2-0010"),
	REGULATOR_SUPPLY("vana_eeprom", "2-0053"),
};

static struct regulator_consumer_supply max77660_ldo3_supply[] = {
	REGULATOR_SUPPLY("avdd_cam1", NULL),
	REGULATOR_SUPPLY("vana_imx119", "2-0037"),
};
...
static struct regulator_consumer_supply max77660_ldo6_supply[] = {
	...
	REGULATOR_SUPPLY("vdig_eeprom", "2-0053"),
	REGULATOR_SUPPLY("vdig_imx119", "2-0037"),
...
static struct regulator_consumer_supply max77660_ldo9_supply[] = {
	...
	REGULATOR_SUPPLY("vdd", "0-0076"),
	REGULATOR_SUPPLY("Vdd", "0-0039"),
	REGULATOR_SUPPLY("Vled", "0-0039"),
};
...
static struct regulator_consumer_supply max77660_ldo15_supply[] = {
	...
	REGULATOR_SUPPLY("vdd_cam_1v8", "2-000c"),
};
...
static struct regulator_consumer_supply max77660_sw2_supply[] = {
	REGULATOR_SUPPLY("vdd_cam_1v8_revc", "2-000c"),
	REGULATOR_SUPPLY("vif", "2-0010"),
	REGULATOR_SUPPLY("vif_eeprom", "2-0053"),
	REGULATOR_SUPPLY("vif_imx119", "2-0037"),
...
MAX77660_PDATA_INIT(BUCK6, buck6,  1600, 1600, NULL, 0,
		0, 0, 1, FPS_SRC_DEF, -1, -1, 0);

MAX77660_PDATA_INIT(BUCK7, buck7,  2500, 2500, NULL, 0,
		0, 0, 1, FPS_SRC_DEF, -1, -1, 0);
...
MAX77660_PDATA_INIT(LDO8, ldo8, 900, 900, max77660_rails(buck3), 0,
		0, 0, 0, FPS_SRC_DEF, -1, -1, MAX77660_EXT_ENABLE_EN3);

MAX77660_PDATA_INIT(LDO9, ldo9, 3000, 3000, NULL, 0,
		1, 1, 1, FPS_SRC_DEF, -1, -1, 0);
...
MAX77660_PDATA_INIT(LDO14, ldo14, 2950, 2950, NULL, 0,
		0, 0, 1, FPS_SRC_DEF, -1, -1, 0);

MAX77660_PDATA_INIT(LDO15, ldo15, 1800, 1800, NULL, 0,
		0, 0, 1, FPS_SRC_DEF, -1, -1, 0);
...
/* 1.8V reference */
uint32_t max77660_adc_temperature_lookup_table_revb[] = {
	118, 121, 125, 128, 131,	/* 125 ~ 121 */
	135, 139, 142, 146, 150, 155, 159, 163, 168, 172,	/* 120 ~ 111 */
	177, 182, 188, 193, 198, 204, 210, 216, 222, 229,	/* 110 ~ 101 */
	235, 242, 249, 257, 264, 272, 280, 288, 297, 306,	/* 100 ~ 91 */
	315, 324, 334, 344, 355, 365, 376, 388, 400, 412,	/* 90 ~ 81 */
	425, 438, 451, 465, 479, 494, 509, 525, 541, 558,	/* 80 ~ 71 */
	575, 593, 611, 630, 650, 670, 690, 712, 734, 756,	/* 70 ~ 61 */
	779, 803, 828, 853, 879, 906, 933, 962, 991, 1020,	/* 60 ~ 51 */
	1051, 1082, 1114, 1147, 1181, 1215, 1250, 1286, 1323, 1360,	/* 50 ~ 41 */
	1398, 1437, 1477, 1517, 1558, 1600, 1642, 1685, 1729, 1773,	/* 40 ~ 31 */
	1818, 1863, 1909, 1955, 2001, 2048, 2095, 2142, 2190, 2238,	/* 30 ~ 21 */
	2285, 2333, 2381, 2429, 2476, 2524, 2571, 2618, 2664, 2711,	/* 20 ~ 11 */
	2756, 2801, 2846, 2890, 2934, 2977, 3019, 3060, 3100, 3140,	/* 10 ~ 1 */
	3179,	/* 0 */
	3217, 3255, 3290, 3325, 3360, 3393, 3425, 3456, 3487, 3516,	/* -1 ~ -10 */
	3544, 3572, 3598, 3624, 3648, 3671, 3694, 3716, 3736, 3756,	/* -11 ~ -20 */
	3775, 3793, 3811, 3827, 3843, 3858, 3872, 3886, 3899, 3911,	/* -21 ~ -30 */
	3922, 3933, 3944, 3954, 3963, 3972, 3980, 3988, 3995, 4002,	/* -31 ~ -40 */
};

/* 2.5V reference */
uint32_t max77660_adc_temperature_lookup_table_revc[] = {
	82, 85, 87, 89, 91, /* 125 ~ 121 */
	94, 96, 99, 102, 104, 107, 110, 113, 116, 120,	/* 120 ~ 111 */
	123, 126, 130, 133, 137, 141, 145, 149, 154, 158,	/* 110 ~ 101 */
	163, 167, 172, 177, 183, 188, 194, 199, 205, 211,	/* 100 ~ 91 */
	218, 224, 231, 238, 246, 253, 261, 269, 278, 286,	/* 90 ~ 81 */
	295, 304, 314, 324, 334, 345, 356, 367, 379, 391,	/* 80 ~ 71 */
	404, 417, 431, 444, 459, 474, 489, 505, 522, 539,	/* 70 ~ 61 */
	557, 575, 594, 614, 634, 655, 676, 699, 722, 745,	/* 60 ~ 51 */
	770, 795, 821, 848, 876, 904, 933, 964, 995, 1027,	/* 50 ~ 41 */
	1059, 1093, 1128, 1163, 1200, 1237, 1275, 1314, 1354, 1395,	/* 40 ~ 31 */
	1437, 1480, 1523, 1567, 1612, 1658, 1704, 1752, 1799, 1848,	/* 30 ~ 21 */
	1897, 1946, 1996, 2046, 2097, 2148, 2199, 2251, 2302, 2354,	/* 20 ~ 11 */
	2405, 2457, 2508, 2559, 2609, 2660, 2710, 2759, 2808, 2856,	/* 10 ~ 1 */
	2903,	/* 0 */
	2950, 2996, 3041, 3085, 3128, 3170, 3212, 3252, 3291, 3329,	/* -1 ~ -10 */
	3366, 3401, 3436, 3469, 3502, 3533, 3563, 3591, 3619, 3646,	/* -11 ~ -20 */
	3671, 3695, 3719, 3741, 3762, 3782, 3802, 3820, 3837, 3854,	/* -21 ~ -30 */
	3869, 3884, 3898, 3911, 3924, 3935, 3946, 3957, 3967, 3976,	/* -31 ~ -40 */
};
...
static struct iio_map max77660_iio_map_revb[] = {
	MAX77660_GPADC_IIO_MAP(ADC2, "generic-adc-thermal.0", "adc2_channel"),
	MAX77660_GPADC_IIO_MAP(NULL, NULL, NULL),
};

static struct iio_map max77660_iio_map_revc[] = {
	MAX77660_GPADC_IIO_MAP(VTHM, "generic-adc-thermal.0", "vthm_channel"),
	MAX77660_GPADC_IIO_MAP(NULL, NULL, NULL),
};

static struct gadc_thermal_platform_data gadc_thermal_battery_pdata_revb = {
	.iio_channel_name = "adc2_channel",
	.tz_name = "battery-temp",
	.temp_offset = 0,
	.adc_to_temp = NULL,
	.adc_temp_lookup = max77660_adc_temperature_lookup_table_revb,
	.lookup_table_size = ARRAY_SIZE(max77660_adc_temperature_lookup_table_revb),
	.first_index_temp = 125,
	.last_index_temp = -40,
};

static struct platform_device gadc_thermal_battery_revb = {
	.name   = "generic-adc-thermal",
	.id     = 0,
	.dev    = {
		.platform_data = &gadc_thermal_battery_pdata_revb,
	},
};

static struct gadc_thermal_platform_data gadc_thermal_battery_pdata_revc = {
	.iio_channel_name = "vthm_channel",
	.tz_name = "battery-temp",
	.temp_offset = 0,
	.adc_to_temp = NULL,
	.adc_temp_lookup = max77660_adc_temperature_lookup_table_revc,
	.lookup_table_size = ARRAY_SIZE(max77660_adc_temperature_lookup_table_revc),
	.first_index_temp = 125,
	.last_index_temp = -40,
};

static struct platform_device gadc_thermal_battery_revc = {
	.name   = "generic-adc-thermal",
	.id     = 0,
	.dev    = {
		.platform_data = &gadc_thermal_battery_pdata_revc,
	},
};

struct max77660_adc_platform_data max77660_adc_pdata_revb = {
	.adc_current_uA = 10,
	.adc_avg_sample = 2,
	.adc_ref_enabled = 0,
	.channel_mapping = max77660_iio_map_revb,
};

struct max77660_adc_platform_data max77660_adc_pdata_revc = {
	.adc_current_uA = 10,
	.adc_avg_sample = 2,
	.adc_ref_enabled = 1,
	.channel_mapping = max77660_iio_map_revc,
};
...
static struct max77660_platform_data max77660_pdata_revb = {
	...
	.adc_pdata = &max77660_adc_pdata_revb,
...
#ifdef CONFIG_MACH_PDA
	.kick_by_tegraWDT = false,
#endif
};

static struct max77660_platform_data max77660_pdata_revc = {
	.irq_base	= MAX77660_IRQ_BASE,
	.gpio_base	= MAX77660_GPIO_BASE,
	...
	.adc_pdata = &max77660_adc_pdata_revc,
...
static struct i2c_board_info __initdata max77660_regulators_revb[] = {
	{
		/* The I2C address was determined by OTP factory setting */
		I2C_BOARD_INFO("max77660", MAX77660_PWR_I2C_ADDR),
		.irq		= INT_EXTERNAL_PMU,
		.platform_data	= &max77660_pdata_revb,
	},
};

static struct i2c_board_info __initdata max77660_regulators_revc[] = {
	{
		/* The I2C address was determined by OTP factory setting */
		I2C_BOARD_INFO("max77660", MAX77660_PWR_I2C_ADDR),
		.irq		= INT_EXTERNAL_PMU,
		.platform_data	= &max77660_pdata_revc,
	},
};
...
static struct tegra_cl_dvfs_cfg_param pda_cl_dvfs_param = {
	.sample_rate = 12500,
...
static struct tegra_cl_dvfs_platform_data pda_cl_dvfs_lp8755_vdd_cpu_data = {
...
static struct tegra_cl_dvfs_platform_data \
				pda_cl_dvfs_max77660_vdd_cpu_data = {
	.dfll_clk_name = "dfll_cpu",
	.pmu_if = TEGRA_CL_DVFS_PMU_I2C,
	.u.pmu_i2c = {
		.fs_rate = 400000,
...
static int __init pda_cl_dvfs_init(void)
{
	struct board_info board_info;
	...
	if ((board_info.board_id == BOARD_E1690) ||
		...
		tegra_cl_dvfs_device.dev.platform_data =
					&pda_cl_dvfs_lp8755_vdd_cpu_data;
	}
...
int __init pda_regulator_init(void)
{
	struct board_info board_info;
...
/*                                                                                            
	...
	if (lge_get_board_revno() == HW_REV_PDA_B) {
		for (id = 0; id < MAX77660_REGULATOR_ID_NR; ++id)
			max77660_pdata_revb.regulator_pdata[id] = max77660_reg_pdata[id];
	}
	else if (lge_get_board_revno() >= HW_REV_PDA_C) {
		for (id = 0; id < MAX77660_REGULATOR_ID_NR; ++id)
			max77660_pdata_revc.regulator_pdata[id] = max77660_reg_pdata[id];
	}
	/* set ldo1 to 0.85v from rev 1 */
	if (lge_get_board_revno() >= HW_REV_D625_1_0) {
		pr_info("[POWER] board revision 1.0!!! so ldo1 voltage to 0.85V !!! \n");
	...
	case BOARD_E1671:
		...
		if (board_info.board_id == BOARD_E1680 &&
			 ...
			 */
			pr_info("%s: BB_PWR_REQ is connected to EN5\n", __func__);
 ...
 */
		if (lge_get_board_revno() == HW_REV_PDA_B) {
			max77660_pdata_revb.system_watchdog_timeout = 0;
		}
		else if (lge_get_board_revno() >= HW_REV_PDA_C) {
			max77660_pdata_revc.system_watchdog_timeout = 0;
		}
	...
	/* pda FAB <= A02 LPDDR3 regulators on SW5 so keep it always_on */
...
/*                                                                                            
	...
	if ((board_info.board_id == BOARD_E1680) && (board_info.fab >= BOARD_FAB_A04)) {
		if (lge_get_board_revno() == HW_REV_PDA_B) {
			max77660_pdata_revb.use_rcm_reset = true;
		}
		else if (lge_get_board_revno() >= HW_REV_PDA_C) {
			max77660_pdata_revc.use_rcm_reset = true;
		}
	}

#if defined(CONFIG_MACH_PDA) && defined(CONFIG_TEGRA_FIQ_DEBUGGER)
    /* tegra wdt kicks PMIC WDT */
    if (lge_get_board_revno() == HW_REV_PDA_B)
        max77660_pdata_revb.kick_by_tegraWDT = true;

    else if (lge_get_board_revno() == HW_REV_PDA_C)
        max77660_pdata_revc.kick_by_tegraWDT = true;
#endif
/*                                                                                            
                                                                                             ...
                                                                                             */
	if (lge_get_board_revno() == HW_REV_PDA_B) {
		i2c_register_board_info(4, max77660_regulators_revb,
					ARRAY_SIZE(max77660_regulators_revb));
		platform_device_register(&gadc_thermal_battery_revb);
	}
	else if (lge_get_board_revno() >= HW_REV_PDA_C) {
		i2c_register_board_info(4, max77660_regulators_revc,
					ARRAY_SIZE(max77660_regulators_revc));
		platform_device_register(&gadc_thermal_battery_revc);
	}

/*                                                                                     */
	if (lge_get_board_revno() <= HW_REV_D625_A_1 && touch_ic_id == 0)
		max77660_regulator_idata_sw1.constraints.always_on = 1;
/*                                              */
...
static int __init pda_fixed_regulator_init(void)
{
	struct board_info board_info;
...
subsys_initcall_sync(pda_fixed_regulator_init);

static void pda_board_suspend(int lp_state, enum suspend_stage stg)
{
...
static void pda_board_resume(int lp_state, enum resume_stage stg)
{
}

#ifdef CONFIG_TEGRA_LP1_LOW_COREVOLTAGE
static struct lpx_corev_reg_lookup pda_reg_lookup[] = {
...
static int pda_lp1_reg_lookup(int voltage)
{
	int i;
	for (i = 0; i < ARRAY_SIZE(pda_reg_lookup); i++)
		if (voltage <= pda_reg_lookup[i].core_voltage)
			return pda_reg_lookup[i].reg_value;
	return 0x65; /* Default Voltage: 1.230V */
}
#endif

static struct tegra_suspend_platform_data pda_suspend_data = {
	.cpu_timer	= 300,
	.cpu_off_timer	= 300,
	...
	.board_suspend = pda_board_suspend,
	.board_resume = pda_board_resume,
#ifdef CONFIG_TEGRA_LP1_LOW_COREVOLTAGE
	/* Settings for pda */
	...
	.lp1_lookup_reg = pda_lp1_reg_lookup,
#endif
...
int __init pda_suspend_init(void)
{
	struct board_info board_info;
	...
	if (board_info.board_id == BOARD_E1680) {
		if (board_info.sku == 1000)
			pda_suspend_data.core_reg_addr = 0x47;
	} else {
		pda_suspend_data.lp1_lowvolt_support = false;
#ifdef CONFIG_TEGRA_WDT_CLEAR_EARLY
		pda_suspend_data.wdt_clear_early_support = false;
#endif

	}
#endif
	tegra_init_suspend(&pda_suspend_data);

	return 0;
}

int __init pda_edp_init(void)
{
...
static struct soctherm_platform_data pda_soctherm_data = {
	.therm = {
		[THERM_CPU] = {
			.zone_enable = true,
			.passive_delay = 1000,
...
#if 0	/* Temporarily disable OC1 throttle until it is verified. */
		[THROTTLE_OC1] = {
			.throt_mode = BRIEF,
			.polarity = 1,
			.pgmask = 1,
...
int __init pda_soctherm_init(void)
{
	struct board_info board_info;
	...
	tegra_platform_edp_init(pda_soctherm_data.therm[THERM_CPU].trips,
				&pda_soctherm_data.therm[THERM_CPU].num_trips,
				14000); /* edp temperature margin */
	tegra_add_tj_trips(pda_soctherm_data.therm[THERM_CPU].trips,
			   &pda_soctherm_data.therm[THERM_CPU].num_trips);
	return tegra11_soctherm_init(&pda_soctherm_data);
}

static struct edp_manager pda_sysedp_manager = {
	.name = "battery",
	.max = 17200
};

void __init pda_sysedp_init(void)
{
	...
	if (get_power_supply_type() != POWER_SUPPLY_TYPE_BATTERY)
		pda_sysedp_manager.max = INT_MAX;

	r = edp_register_manager(&pda_sysedp_manager);
	WARN_ON(r);
	if (r)
		return;
	...
	r = edp_set_governor(&pda_sysedp_manager, g);
	WARN_ON(r);
}

static unsigned int pda_psydepl_states[] = {
...
static struct psy_depletion_ibat_lut pda_ibat_lut[] = {
	{  600,  500 },
	{  400, 3000 },
	{    0, 3000 },
	{ -300,    0 }
...
static struct psy_depletion_rbat_lut pda_rbat_lut[] = {
	{ 100, 136000 },
	{  90, 108000 },
	{  80,  96000 },
	{  70,  84000 },
...
static struct psy_depletion_ocv_lut pda_ocv_lut[] = {
	{ 100, 4200000 },
	{  90, 4151388 },
	{  80, 4064953 },
	{  70, 3990914 },
...
static struct psy_depletion_platform_data pda_psydepl_pdata = {
	.power_supply = "battery",
	.states = pda_psydepl_states,
	.num_states = ARRAY_SIZE(pda_psydepl_states),
	.e0_index = 26,
	.r_const = 141600,
	.vsys_min = 3250000,
	.vcharge = 4200000,
	.ibat_nom = 3000,
	.ibat_lut = pda_ibat_lut,
	.ocv_lut = pda_ocv_lut,
	.rbat_lut = pda_rbat_lut
};

static struct platform_device pda_psydepl_device = {
	.name = "psy_depletion",
	.id = -1,
	.dev = { .platform_data = &pda_psydepl_pdata }
};

void __init pda_sysedp_psydepl_init(void)
{
	int r;

	r = platform_device_register(&pda_psydepl_device);
	WARN_ON(r);
}

static struct tegra_sysedp_corecap pda_sysedp_corecap[] = {
...
static struct tegra_sysedp_platform_data pda_sysedp_platdata = {
	.corecap = pda_sysedp_corecap,
	.corecap_size = ARRAY_SIZE(pda_sysedp_corecap),
	.core_gain = 100,
	.init_req_watts = 11000,
	.bbc = "bbc"
};

static struct platform_device pda_sysedp_device = {
	.name = "tegra_sysedp",
	.id = -1,
	.dev = { .platform_data = &pda_sysedp_platdata }
};

void __init pda_sysedp_core_init(void)
{
	int r;

	pda_sysedp_platdata.cpufreq_lim = tegra_get_system_edp_entries(
			&pda_sysedp_platdata.cpufreq_lim_size);
	if (!pda_sysedp_platdata.cpufreq_lim) {
		WARN_ON(1);
		return;
	}

	r = platform_device_register(&pda_sysedp_device);
	WARN_ON(r);
}
